...
const NeedToHirePage = () => {
  ...
  return (
    <>
      ...
      <div class="container">
        <h4 class="style_h4 mt-4">Need to Hire?</h4>
        <div class="out_border_wrapper">
            <div class="row">
              <div class="col-md-12">
                  <div class="contact_us_content">
                    <div class="hire_candidates_card">
                        <span class="hire_candidates_img"><img src="/images/need_to_hire_img.jpg" alt=""/></span>
