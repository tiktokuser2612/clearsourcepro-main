...
const RecruiterMyAccount = ({ data,isPuttingPassword , getMe, initMe,changePassword }) => {
...
useEffect(() => {
    ...
    getMe();
     ...
     recruiterNotificationAboutCompanyAssociation()
     
 }, [initMe, getMe]);

    const recruiterNotificationAboutCompanyAssociation = async () => {
        const res = await api.recruiter.notication.getNotificationDetails()
        if(res.data.length){
   ...
   <div>
        <div className="health_insurance_main">
            ...
            <div className="health_card w-100 d-flex justify-content-between mt-0">
                <h1>Review Recruiter <Link to="/recruiter/dashboard/edit">Edit</Link></h1>
            ...
            <div id="accordion" className="record_accordion">
                ...
                <div className="card">
                    ...
                    <div id="collapseFive" className={Active.includes(6)?"collapse show":"collapse"} aria-labelledby="headingFive" data-parent="#accordion">
                        <div className="card-body p-0">
...
export default connect(mapStateToProps, mapDispatchToProps)(RecruiterMyAccount);
