...
const CREATE_ACCOUNT_EXECUTIVE_SCHEMA = {
...
const AccountExecutiveEditProfile = ({isPuttingMe, edited, data, initMe, editMe, putMe}) => {
    ...
    const handlePost = (e) => {
        ...
        // Validate all fields
        const errors = Joi.validateToPlainErrors(data, CREATE_ACCOUNT_EXECUTIVE_SCHEMA);
        ...
        putMe(formData)
            .then(res => {
                ...
                initMe();
                history.push('/account_executive/dashboard/'); 
            })
            .catch(err => {
    ...
    const handleChange = (key, val) => {
        ...
        setErrors({
            ...errors,
            [key]: Joi.validateToPlainErrors(val, CREATE_ACCOUNT_EXECUTIVE_SCHEMA[key]),
        });
    ...
    return (
        <div className="health_insurance_main">
            ...
            <div className="">
                <h1>Update Account Executive <Link to="/account_executive/dashboard">Back</Link></h1>
            </div>                    
...
export default connect(mapStateToProps, mapDispatchToProps)(AccountExecutiveEditProfile);
