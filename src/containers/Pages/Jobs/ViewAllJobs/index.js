  ...
  return (
    <>
      ...
      <div className="banner_section">
        <img className="h-100" src="/images/contact_banner.png" alt="" />
        <div className="banner_text">
          <div className="container">
            <div className="row">
              <div className="col-md-8 m-auto">
                <h1 style={{ color: '#d1d3d7' }}>View all jobs</h1>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="job_list_card d-md-flex justify-content-between align-items-center">
              ...
              <div>
                <button className="apply_btn" type="button" onClick={gotoUrl('/jobs/1/apply')}>Apply now</button>
              </div>
            </div>
