...
const Review = ({
    ...
    useEffect(() => {
        ...
        user.requisition_permissions.filter(p => p.status == 1 && p.permission == 'R' || p.permission == 'Display').map(p=>{
    ...
    return (
        <div className="health_insurance_main">
            ...
            <div id="accordion" className="record_accordion">
                <div className="card">
                { accordion['Details'] && <div className="card-header" id="headingOne">
                        <h2 className="mb-0">
                    ...
                    <div className="card-body p-0">
                            ...
                            <div className="d-md-flex justify-content-between">
                                <div className="health_card elite_health">
                                    ...
                                    <p>{data?.get_hring_manager_name?.hiring_manager_name}</p>
                                </div>
                                <div className="health_card elite_health">
                                    <label>Other Recruiter</label>
                                    <p>{data ?.get_other_recruiter ? data.get_other_recruiter.firstname : ''}</p>
                                </div>
                                <div className="health_card elite_health">
                                    <label>Salary</label>
                                    <p>{data.salary}</p>
                                        ...
                                        <div className="table-responsive w_bg">
                                            <table className="table table-condensed mb-0" style={{borderCollapse:"collapse"}}>
                                                ...
                                                {!!data?.get_candidate_jobs && data?.get_candidate_jobs?.map((candidate) => {
                                                    return (
                                                        <tr>
                                                        <td><i className="fa fa-plus-circle" aria-hidden="true"></i> {candidate?.get_candidate?.firstname}</td>
                        ...
                        <div id="collapseFour" className={Active.includes(5)?"collapse show":"collapse"} aria-labelledby="headingFour" data-parent="#accordion">
                            <div className="card-body p-0">
                                <div className="d-md-flex justify-content-between">
                                    ...
                                    <div className="health_card elite_health">
                                        <label>Phone</label>
                                        <p>{data.client_phone ? data.client_phone : null}</p>
                                    </div>
                                    <div className="health_card elite_health">
                                        <label>Email</label>
                                        <p>{data.client_email ? data.client_email : null}</p>
                                    </div>
                                </div>
                                <div className="d-md-flex justify-content-between">
                                    <div className="health_card elite_health">
                                    ...
                                    <div className="health_card elite_health">
                                        ...
                                        <p>{data.general_type_of_insurance_licensed_needed }</p>
                                    </div>
                                </div>
                                <div className="d-md-flex justify-content-between">
                                    <div className="health_card elite_health">
