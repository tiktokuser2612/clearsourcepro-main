                ...
                <nav>
                    ...
                    <div className="tab-pane" id="nav-Notes" role="tabpanel" aria-labelledby="nav-Notes-tab">
                        ...
                        <div className="d-flex justify-content-end mb-2"><div className="health_card">
                                    <label className="d-flex justify-content-end"><Link className="text-decoration-none" to="client_notes_create"><i className="fa fa-plus-circle" aria-hidden="true"></i> Create New Notes</Link></label>
