...
const UPDATE_CLIENT_SCHEMA = {
    ...
    address_type: Joi.string().min(5).label('Address').required().error(() => ({
        message: 'Please select address type',
    })), 
    client_id: Joi.label('Primary Contact Name').required(),
    ...
    contact_info_name : Joi.string().label('Contact Name').required(),
    ...
    locations : Joi.string().label('Location').required(),
    account_executive_id: Joi.label('Location').required(),
};



const Edit = ({initAdminClientUsers, data,  editAdminClientUsers, getAdminClient, putAdminClient, isPutting, isFetching , user }) => {
    ...
    useEffect(() => {
        ...
        let acc = {...accordion}
        user.client_permissions.filter(p => p.status == 1 && p.permission == 'U').map(p=>{
    ...
    const handlePut = (e) => {
        ...
        // Validate all fields
        const errors = Joi.validateToPlainErrors(data, (['client', 'admin'].indexOf(data.user_role) === -1) ? UPDATE_CLIENT_SCHEMA : UPDATE_CLIENT_SCHEMA);
        setErrors(errors);
        ...
        if (Joi.hasPlainError(errors)) {
            ...
            putAdminClient(id, data)
            .then(res => {
                notifier.success('Update user success!');
                initAdminClientUsers();
                history.push('/admin/clients/view/'+id); 
            })
            .catch(err => {
    ...
    const handleChange = (key, val) => {
        ...
        setErrors({
            ...errors,
            [key]: Joi.validateToPlainErrors(val, UPDATE_CLIENT_SCHEMA[key]),
        });
    ...
    const handleZipcodeSearchCompleteContactInfo = (contact_info_city, contact_info_state) => {
        ...
        <div className="health_insurance_main">
                ...
                <div className="health_card elite_health">
                    ...
                    <div className="d-md-flex justify-content-between">
                        ...
                        <div className="health_card elite_health">
                            ...
                            <Select 
                                value={data.client_id ? data.client_id : 'Select Client'}
                                className="w-100 custom-select"
                    ...
                    <div className="d-md-flex justify-content-between">
                        ...
                        <label>Account Executive</label>
                            ...
                            <Select 
                                value={`${data.account_executive_id}`}
                                className="w-100 custom-select"
            ...
            { accordion['Reqs'] && <div className="card">
                    ...
                    <div id="collapseThree" className="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                        ...
                        <div className="d-md-flex justify-content-between">
                            <div className="health_card elite_health">
                                ...
                                <Input
                                    ...
                                    value={data.contact_info_name ? data.contact_info_name: data?.get_client_manager?.contact_info_name}
                            ...
                            <div className="health_card elite_health">
                                ...
                                <PhoneInput
                                    type="text"
                                    placeholder="Phone Number"
                                    value={data.contact_info_phone ? data.contact_info_phone: data?.get_client_manager?.contact_info_phone}
                                    country="US"
                                    minLength="14"
                                    maxLength="14"    
                            ...
                            <div className="health_card elite_health">
                                ...
                                <Input
                                    placeholder="Clearwaater, FI (Primary)"
                                    value={data.contact_info_email ? data.contact_info_email: data?.get_client_manager?.contact_info_email}
                        ...
                        <div className="d-md-flex justify-content-between">
                            <div className="health_card elite_health">
                                <label>Address</label>
                                <Form.Item
                                validateStatus={Joi.getFirstPlainError(errors, 'contact_info_address') ? 'error' : ''}
                                ...
                                <Input
                                    ...
                                    value={data.contact_info_address ? data.contact_info_address: data?.get_client_manager?.contact_info_address}
                            ...
                            <div className="health_card elite_health">
                                ...
                                <ZipcodeInput
                                    validateStatus={Joi.getFirstPlainError(errors, 'contact_info_zip') ? 'error' : ''}
                                    help={Joi.getFirstPlainError(errors, 'contact_info_zip')}
                                    placeholder="Zip code"
                                    label="Zip"
                                    value={data.contact_info_zip ? data.contact_info_zip: data?.get_client_manager?.contact_info_zip}
                            ...
                            <div className="health_card elite_health">
                                ...
                                <Input
                                    placeholder="Clearwaater, FI (Primary)"
                                    value={data.contact_info_city ? data.contact_info_city: data?.get_client_manager?.contact_info_city}
                        ...
                        <div className="d-md-flex justify-content-between">
                            <div className="health_card elite_health">
                                ...
                                <Form.Item
                                   ...
                                   <Input
                                       placeholder="Clearwaater, FI (Primary)"
                                       value={data.contact_info_state ? data.contact_info_state: data?.get_client_manager?.contact_info_state}
                            ...
                            <div className="health_card w-100">
                                ...
                                >
                                    <textarea
                                        ...
                                        value={data.description ? data.description: data?.get_client_manager?.description}
                ...
                <div className="account_form_style d-flex align-items-center mt-4">
                    <button className="update m-0" type="button" onClick={handlePut}>Edit Client</button>
...
const mapStateToProps = store => ({
    ...
    isPutting: store.rootReducer.adminNewClient.isPutting,
    edited: store.rootReducer.adminNewClient.edited,
