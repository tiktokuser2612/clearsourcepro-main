          ...
          <div className="col-md-12">
            ...
            <div className="d-flex justify-content-left">
              <div className="account_form_style">
                <button type="button" onClick={gotoUrl('/user/jobs/123/apply')}>Apply Now</button>
                <button className="cancel" type="button" onClick={gotoUrl('/user/jobs')}>Cancel</button>
              </div>
            </div>
...
export default UserViewJobDetailsPage;
