                  ...
                  <div className="col-md-12">
                    ...
                    <div className="d-flex justify-content-start mb-md-5">
                      <div className="account_form_style">
                        <button className="ml-md-0" type="button" onClick={gotoUrl('/user/jobs/123')}>Apply now</button>
                        <button className="transparent" type="button" onClick={gotoUrl('/user/jobs/123')}>Cancel</button>
                      </div>
                    </div>
...
export default UserApplyToJobPage;
