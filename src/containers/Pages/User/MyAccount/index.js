              ...
              <div className="d-flex justify-content-between align-items-baseline">
                <div>
                  ...
                  <div className="main_btns">
                    <Link to="/user/jobs">View Applied Job</Link>
                    <Link className="gray" to="/saved-jobs">View Saved Job</Link>
                  </div>
                </div>
                <div className="main_btns right_btns">
                  <Link to="/user/account/edit">Edit</Link>
