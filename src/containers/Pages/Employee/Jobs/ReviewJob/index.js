          ...
          <div className="col-md-12">
            ...
            <div className="d-flex justify-content-left">
              <div className="account_form_style">
                <button type="button" data-toggle="modal" data-target="#update_job">Confirm</button>
                <button className="cancel" type="button" onClick={gotoUrl('/employee/jobs/123/edit')}>Edit</button>
              </div>
            </div>
          ...
          <div className="modal-content border-0">
            ...
            <div className="modal-body">
              ...
              <div className="text-center mb-3">
                ...
                <button className="btn_style_2" type="button" data-dismiss="modal">Ok</button>
              </div>
            </div>
          </div>
        </div>
...
export default EmployeeReviewJobPage;
