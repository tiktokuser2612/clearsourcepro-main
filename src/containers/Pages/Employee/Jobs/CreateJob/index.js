        ...
        <div className="row">
          ...
          <div className="col-md-8">
            ...
            <div className="d-flex justify-content-center">
              <div className="account_form_style">
                <button type="button" onClick={gotoUrl('/employee/jobs/123/review')}>Review & Confirm</button>
                <button className="cancel" type="button" onClick={gotoUrl('/employee/account')}>Cancel</button>
              </div>
            </div>
          </div>
        </div>
...
export default EmployeeCreateJobPage;
