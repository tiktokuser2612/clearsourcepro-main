...
const notesReducer = (state = INITIAL_STATE, action) => {
  switch (action.type) {
    // Post
    case types.NOTES_POST_REQUEST:
      return {
        ...state,
        isPosting: true,
        msg: '',
      };
    case types.NOTES_POST_SUCCESS:
      return {
        ...state,
        isPosting: false,
        edited: false,
    ...
    // Get list
    case types.NOTES_GET_LIST_REQUEST:
      return {
        ...state,
        isFetchingList: true,
        pagination: {
      ...
      case types.NOTES_GET_LIST_SUCCESS:
      return {
        ...state,
        isFetchingList: false,
      ...
      case types.NOTES_GET_LIST_FAILURE:
      return {
        ...state,
        isFetchingList: false,
        items: [],
